...
Set_aria2_RPC_dir(){
	...
	read -e -p "(默认位置: /www/aria2/Download):" aria2_RPC_dir
	[[ -z "${aria2_RPC_dir}" ]] && aria2_RPC_dir="/www/aria2/Download"
	echo
...
echo && echo -e " Aria2 一键安装管理脚本-H酱 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
